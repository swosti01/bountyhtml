...
<html>
  <head>
    ...
    <style>
      ...
      .signinFrom{padding:10px 0 100px 0;}
      .signinInputs{font-size:18px;padding:10px;background:var(--col3);border:1px solid #000;border-radius:6px;
        margin:10px 0;}
    ...
    <div class="signinBody bor">
      <div class="inrSigninBody bor flex fdc h100">
        ...
        <div class="signinNavbar bor flex jcsb">
          <a href="index.jsp" class="signinMainTitleCrate ff1 totext">
            BOUNTY
          </a>            
          <div class="signinMainLinkCrate flex jcfe ff1">
            ...
            <a href="signup.jsp" class="signinSingleLink bor flexmid">Sign Up</a>
          </div>
        </div>
        ...
        <div class="signinContentCrate bor fg1 flex">
          ...
          <div class="signinFormCrate bor w50 flex fdc jcc">
            ...
            <form action="user?page=insert" method="post" class="signinFrom bor flex fdc" >
              <input type="text" class="signinInputs signinInputEmail ff1" placeholder="work email">
              <input type="text" class="signinInputs signinInputEmail ff1" placeholder="password">
              <div class="signinSigninCrate bor flex pb10">
                <a href="" class="signinButton totext ff1">Sign In</a>
              </div>
